                        ...
                        <div class="col-lg-6 col-md-6 col-12 mt-3 mb-4 mb-lg-0">
                            <div class="custom-block bg-white shadow-lg">
                                <a href="{{route('topics_detail', $trending_topics[0]->id)}}">
                                    <div class="d-flex">
                                        <div>
                                            <h5 class="mb-2" title="{{$trending_topics[0]['topic_title']}}">{{Str::limit($trending_topics[0]['topic_title'],60,'...')}}</h5>
                            ...
                            <div class="custom-block custom-block-overlay">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="custom-block-overlay-text d-flex">
                                        <div>
                                            <h5 class="text-white mb-2" title="{{$trending_topics[1]['topic_title']}}">{{Str::limit($trending_topics[1]['topic_title'],60,'...')}}</h5>
