                        ...
                        <div class="carousel-item {{($loop->first)?'active':''}}">
                            <div class="row mx-md-5">
                                ...
                                <div class="col-md-8 px-md-5 d-flex flex-column justify-content-center">
                                    <h3>{{$testimonial['name']}}<br><strong class="date">{{date('d/m/Y', strtotime($testimonial['created_at']))}}</strong></h3>
                                    <p class="text-muted" style="white-space: pre-line;">{{$testimonial['content']}}</p>
                                </div>
                            </div>
                        </div>
                     @endforeach
