    ...
    <div class="mx-2">
      ...
      <form action="{{route('topics.store')}}" method="post" class="px-md-5" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="text" placeholder="e.g. Design Patterns" class="form-control py-2" name = "topic_title" value="{{old('topic_title')}}" />
            @error('topic_title')
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="file" class="form-control" style="padding: 0.7rem;" name="image" accept="image/*" />
              @error('image')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror
          </div>
